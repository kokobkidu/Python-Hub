...
def home():
    ...
    # አናት ላይ የሚታዩት የቀናት ማጣሪያዎች (Besoccer style)
    dates_list = []
    ...
    # Koki Score ሁልጊዜ ውብ እና የተሟላ እንዲሆን የተዘጋጁ እውነተኛ የሚመስሉ የጨዋታ መርሃ-ግብሮች
    all_matches = {
        selected_date: [
            ...
            {"category": "🏆 Spanish La Liga", "home": "Real Madrid", "away": "Barcelona", "h_score": 3, "a_score": 2, "status": "FT"},
            {"category": "🤝 Club Friendly", "home": "FC Tokyo", "away": "Nagoya Grampus", "h_score": 1, "a_score": 1, "status": "FT"},
    ...
    # ለተመረጠው ቀን ግጥሚያዎች (ከሌለ ነባሪ ማሳያ)
    matches = all_matches.get(selected_date, [
        {"category": "🤝 Club Friendly", "home": "Brinje-Grosuplje", "away": "FK Epitsentr", "h_score": 2, "a_score": 3, "status": "FT"},
        {"category": "⚽ Women's League", "home": "City Girls", "away": "United Ladies", "h_score": 1, "a_score": 0, "status": "FT"}
    ])
